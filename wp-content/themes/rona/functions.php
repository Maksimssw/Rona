<?php
    add_action( 'wp_enqueue_scripts', function(){
        ...
        wp_enqueue_style( 'contacts',  get_template_directory_uri() . "/assets/static/styles/contacts.css");

        wp_enqueue_script( 'map', "https://api-maps.yandex.ru/2.1/?apikey=74e40120-797d-440f-824a-74061dbaf7e4&lang=ru_RU", 'null', true);
